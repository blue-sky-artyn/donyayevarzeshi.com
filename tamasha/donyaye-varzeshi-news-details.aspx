<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="donyaye-varzeshi-news-details.aspx.cs" Inherits="tamasha_news_details" %>
				...
				<div class="row">
					...
					<div class="col-md-7" style="background-color: white;">
						...
						<div class="article-comments">
							...
							<!-- comment -->
							<div id="simularNewsHtml" runat="server" class="media">
