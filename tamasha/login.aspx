        ...
        <div class="wrapper">
            <div class="container">
                ...
                <form class="form">
                    ...
                    <asp:Button ID="btnEnter" runat="server" ClientIDMode="Static" Text="Enter" OnClick="btnEnter_Click" />
                    <asp:Button ID="btnReg" runat="server" ClientIDMode="Static" Text="Registration" OnClick="btnReg_Click" />
