<%@ Page Title="" Language="C#" MasterPageFile="~/admin/menu.master" AutoEventWireup="true" CodeFile="main-bg.aspx.cs" Inherits="admin_Default" %>
        ...
        <div class="fo-top-di">
            <div class="foot-top">
                ...
                <div class="col-md-4 s-c">
                    <div class="stay">
                        ...
                        <div class="stay-left">
                            <fieldset class="div_top">
                                ...
                                <asp:FileUpload ID="fuFile1" runat="server" Style="margin: 3%" />
                            </fieldset>
                            <asp:Button ID="btnSave1" runat="server" CssClass="btn btn-primary" Text="Update" OnClick="btnSave1_Click" />
                        </div>
                    ...
                    <div class="col-md-4">
                        <img id="img1" runat="server" class="show-pic" src ="../images/about.png" alt="" />
                        </div>
            </div>
                <hr />
                <div class="row">
                ...
                <div class="col-md-4 s-c">
                    <div class="stay">
                        ...
                        <div class="stay-left">
                            <fieldset class="div_top">
                                <legend>File input</legend>
                                <asp:FileUpload ID="fuFile2" runat="server" Style="margin: 3%" />
                            </fieldset>
                            <asp:Button ID="btnSave2" runat="server" CssClass="btn btn-primary" Text="Update" OnClick="btnSave2_Click" />
                        </div>
                    ...
                    <div class="col-md-4">
                        <img id="img2" runat="server" class="show-pic" src ="../images/iStock-178773678.jpg" alt="" />
                        </div>
            </div>
