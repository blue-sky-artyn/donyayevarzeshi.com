<%@ Page Title="" Language="C#" MasterPageFile="~/admin/menu.master" AutoEventWireup="true" CodeFile="event-add.aspx.cs" Inherits="admin_need_to_know" %>
            ...
            <div class="tab-main">
                ...
                <div class="tab-inner">
                    <div class="col-md-12 graph-2">
                        <h3 class="inner-tittle">Add Events </h3>
                        <div class="form-body">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <CKEditor:CKEditorControl ID="ckNews" class="form-control"  runat="server" placeholder="A short detail" Width="100%"></CKEditor:CKEditorControl>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Price: </label>
                                    <asp:TextBox ID="txtPrice" runat="server" Width="15%"></asp:TextBox> $
                                </div>
                                <div class="form-group">
                                    <blockquote>
                                    <label for="exampleInputEmail1">Start Deal: </label>
                                    <asp:TextBox ID="txtStartDeal" runat="server" Width="15%"></asp:TextBox>

                                    <label for="exampleInputEmail1">End Deal: </label>
                                    <asp:TextBox ID="txtEndDeal" runat="server" Width="15%"></asp:TextBox>
                ...
                <div id="eventsHtml" runat="server">
