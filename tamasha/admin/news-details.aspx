<%@ Page Title="" Language="C#" MasterPageFile="~/admin/menu.master" AutoEventWireup="true" CodeFile="news-details.aspx.cs" Inherits="admin_gallery_normal_detail" %>
        ...
        <div class="women_main">
            ...
            <div class="row single">
                <div class="det">
                    ...
                    <div class="single_left">
                        <div class="btn_form">
                            <asp:Button ID="Button1" runat="server" CssClass="btn-in-cp" Text="DEL" OnClick="btnDel_Click" />
                        </div>
                    </div>
                                    ...
                                    <div class="form-body">
                                        <div>
                                            ...
                                            <div class="form-group" style="width: 100%; line-height: 34px; float: left; margin-right: 5px;">
                                                <label for="ckNews">Details: </label>
