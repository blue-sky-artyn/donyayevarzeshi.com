<%@ Page Title="" Language="C#" MasterPageFile="~/admin/menu.master" AutoEventWireup="true" CodeFile="groups-art.aspx.cs" Inherits="admin_gallery_groups" %>
                                ...
                                <div class="form-body">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <asp:TextBox ID="txtGroupName" class="form-control" runat="server" placeholder="Eg. 12*10"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
