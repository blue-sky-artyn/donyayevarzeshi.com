<%@ Page Title="" Language="C#" MasterPageFile="~/admin/menu.master" AutoEventWireup="true" CodeFile="groups-color.aspx.cs" Inherits="admin_gallery_groups" %>
									...
									<div class="form-body">
										<div class="form-horizontal"> 
                                            <div class="form-group"> 
                                                ...
                                                <div class="col-sm-9"> 
                                                    <asp:TextBox ID="txtColorName" class="form-control" runat="server" placeholder="Eg. White"></asp:TextBox>
                                                </div>
                                            </div> 
                                            <div class="form-group">
                                                <label for="inputPassword3" class="col-sm-2 control-label">Group detail</label> 
                                                <div class="col-sm-9"> 
                                                    <asp:TextBox ID="txtColorCode" class="form-control" runat="server" placeholder="Eg. #FFFFFF"></asp:TextBox>
                                                </div>
                                            </div> 
