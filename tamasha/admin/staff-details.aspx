<%@ Page Title="" Language="C#" MasterPageFile="~/admin/menu.master" AutoEventWireup="true" CodeFile="staff-details.aspx.cs" Inherits="admin_gallery_normal_detail" %>
								...
								<div class="form-body">
									<div> 
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <asp:TextBox ID="txtMajor" class="form-control" runat="server" placeholder="Enter level of study" Width="25%"></asp:TextBox>
