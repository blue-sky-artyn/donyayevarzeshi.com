<%@ Page Title="" Language="C#" MasterPageFile="~/admin/menu.master" AutoEventWireup="true" CodeFile="news-rss.aspx.cs" Inherits="admin_gallery_groups" %>
									...
									<div class="form-body">
										<div class="form-horizontal"> 
                                            <div class="form-group"> 
                                                <label for="inputEmail3" class="col-sm-2 control-label">Group of news</label>
                                                <div class="col-sm-9"> 
                                                    <asp:DropDownList ID="ddlGroup" runat="server"></asp:DropDownList>
                                                </div>
                                            </div> 
                                            <div class="form-group"> 
                                                <label for="inputEmail3" class="col-sm-2 control-label">Website of RSS provider</label>
                                                <div class="col-sm-9"> 
                                                    <asp:TextBox ID="txtwebsite" class="form-control" runat="server" placeholder="Eg. www.news.ca"></asp:TextBox>
                                                </div>
                                            </div> 
                                            <div class="form-group"> 
                                                <label for="inputEmail3" class="col-sm-2 control-label">Rss title</label>
                                                <div class="col-sm-9"> 
                                                    <asp:TextBox ID="txtTitle" class="form-control" runat="server" placeholder="Eg. News of day"></asp:TextBox>
                                                </div>
                                            </div> 
                                            <div class="form-group">
                                                <label for="inputPassword3" class="col-sm-2 control-label">RSS link</label> 
                                                <div class="col-sm-9"> 
                                                    <asp:TextBox ID="txtLink" class="form-control" runat="server" placeholder="Eg. a https://www.facebook.com/rss"></asp:TextBox>
                                                </div>
                                            </div> 
        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <asp:DropDownList ID="ddlNewsGrp" runat="server"></asp:DropDownList>
                    <span>Title: </span>
                    <asp:TextBox ID="txtRssTitle" runat="server" Width="100%"></asp:TextBox><br />
                    <span>Website of RSS provider: </span>
                    <asp:TextBox ID="txtRssWebsite" runat="server" Width="100%"></asp:TextBox><br />
                    <span>RSS link: </span>
                    <asp:TextBox ID="txtRssLink" runat="server" Width="100%"></asp:TextBox><br />
