...
public partial class admin_need_to_know : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //                 "<h3>" + faqTbl[i].question + "</h3>" +
        //                 "<p>" + faqTbl[i].answer + "</p><a href='faq-delete.aspx?itemCode=" + faqTbl[i].id + "'>Delete</a></div>";
        //}
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    faqTbl.question = txtTitle.Text;
        //    faqTbl.answer = txtDetail.Text;
        //    faqTbl.allow = "1";
        //    faqTbl.Create();
