<%@ Page Title="" Language="C#" MasterPageFile="~/admin/menu.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="admin_Default" %>
								...
								<div class="middle-content">
									...
									<!-- start content_slider -->
										<div id="owl-demo" class="owl-carousel text-center">
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="../images/gallery/pic1.jpg" alt="name">
											</div>
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="../images/gallery/pic2.jpg" alt="name">
											</div>
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="../images/gallery/pic3.jpg" alt="name">
											</div>
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="../images/gallery/pic4.jpg" alt="name">
											</div>
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="../images/gallery/pic5.jpg" alt="name">
											</div>
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="../images/gallery/pic6.jpg" alt="name">
											</div>
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="../images/gallery/pic7.jpg" alt="name">
											</div>
