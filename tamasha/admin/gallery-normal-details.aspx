<%@ Page Title="" Language="C#" MasterPageFile="~/admin/menu.master" AutoEventWireup="true" CodeFile="gallery-normal-details.aspx.cs" Inherits="admin_gallery_normal_detail" %>
                ...
                <div class="det">
                    ...
                    <div class="single-bottom1">
                        ...
                        <asp:TextBox ID="txtPrice" runat="server" Width="100px" placeholder="Eg. 1200" Font-Size="14px"></asp:TextBox>
                                $    /
                                <asp:Label ID="lblOldPrice" runat="server" CssClass="price-old" Text="$1200"></asp:Label><br />
                            </div>
                            <div class="change-items">
                                Item Discount:<br />
                                <asp:RadioButtonList ID="rblDiscount" runat="server" CssClass="raido-button-list" RepeatLayout="UnorderedList" RepeatDirection="Vertical">
                                    <asp:ListItem Text="Exact Aamount" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Percent" Value="2"></asp:ListItem>
                                </asp:RadioButtonList><br />
                        <asp:TextBox ID="txtDiscount" runat="server" Width="100%" placeholder="Eg. 1200 Or 25 without %  " Font-Size="14px"></asp:TextBox>
                            </div>
                        <div class="change-items">
                            Item title:
                        ...
                        <div class="left-change-item">
                            ...
                            <fieldset class="div_top">
                                <legend>Change shape</legend>
                                <asp:DropDownList ID="ddlShape" runat="server"></asp:DropDownList>
                            </fieldset>
                        </div>
                        <div class="left-change-item">
                            <fieldset class="div_top">
