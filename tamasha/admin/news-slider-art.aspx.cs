...
public partial class admin_news_flagged_sport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sliderTbl.ReadList(Criteria.NewCriteria(tblSlider.Columns.SliderTitle,CriteriaOperators.IsNotNull));
        ...
        if (newsDetTbl.Count > 0)
        {
            ...
            {
                sliderTbl.ReadList(Criteria.NewCriteria(tblSlider.Columns.SliderTitle, CriteriaOperators.Like, newsDetTbl[i].id.ToString()));
        ...
        for (int i = 1; i < newsGroupTbl.Count; i++)
        {
            ...
            if (newsDetTbl.Count > 0)
            {
                ...
                {
                    sliderTbl.ReadList(Criteria.NewCriteria(tblSlider.Columns.SliderTitle, CriteriaOperators.Like, newsDetTbl[j].id.ToString()));
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        sliderOldTbl.ReadList(Criteria.NewCriteria(tblSlider.Columns.SliderTitle, CriteriaOperators.IsNotNull));
        ...
        for (int i = 0; i < value.Length; i++)
        {
            ...
            {
                sliderAddTbl.SliderTitle = value[i].ToString();
                sliderAddTbl.SliderLink = "";
        ...
        Response.Redirect("news-slider-art.aspx");
    }
}